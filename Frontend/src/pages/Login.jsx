    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center bg-paper px-6">
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200/70 w-full max-w-sm">
          <h2 className="font-display text-xl font-semibold mb-1 text-ink">Sign in</h2>
          <p className="text-sm text-slate-400 mb-6">Welcome back, let's get to your dashboard.</p>
          ...
          <p className="text-sm text-slate-500 mt-5 text-center">
            No account? <Link to="/register" className="text-cobalt-600 font-medium">Register</Link>
          </p>
        </form>
      </div>
    </div>
